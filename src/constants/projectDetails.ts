...
export const projectDetails: ProjectDetail[] = [
  {
    ...
    myContributionsDetails: [
      ...
      "Tailwind CSS를 이용하여 다크모드 구현하였습니다. 다크모드 상태를 Zustand-Persist를 이용하여 로컬 스토리지에 저장하였고, 다크모드 상태에 따라 텍스트 색상과 배경색을 변경하였습니다. 아이콘 같은 경우에 디자이너와 소통하여 다크모드 상태에 따라 다른 색상의 아이콘을 제공받아 구현하였습니다.",
      "게시판의 댓글과 답글 기능을 구현했습니다. 특히 답글이 여러 단계로 중첩될 경우, 백엔드 서버에서 받아오는 댓글 리스트 데이터가 계층적으로 쌓이게 되는데, 이를 효율적으로 처리하기 위해 재귀 함수를 활용해 댓글 컴포넌트를 구현했습니다.",
