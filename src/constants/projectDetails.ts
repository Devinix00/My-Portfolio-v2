export const projectDetails = [
  ...
  },
  {
    title: "휘뚜루 마뚜루",
    description:
      "시계와 명품에 관련된 커뮤니티 서비스입니다. 외주 개발로 프로젝트에 참여하였습니다.",
    ...
    myContributions: ["회원가입", "비밀번호 변경", "사용자 시계 커스텀"],
    myContributionsDetails: [
      "소셜 로그인을 사용하지 않는 이용자들을 위한 회원가입 기능을 구현하였습니다. 비밀번호의 유효성 검사에는 yup 라이브러리를 활용하여 특수 문자와 대소문자 등의 조건을 충족하도록 하였고, SMS 인증 기능도 구현하였습니다. 또한, 이메일과 닉네임의 중복 여부를 확인하는 예외처리를 하였습니다.",
      "비밀번호를 잊은 유저들을 위한 비밀번호 변경 기능을 구현하였습니다. 유저는 SMS 혹은 가입된 Email로 인증번호를 받아 인증에 성공한 뒤, 유저는 비밀번호를 수정할 수 있습니다.",
      "유저가 원하는 디자인의 시계를 커스텀하는 기능을 구현하였습니다. 재질, 베젤, 브레이슬릿, 다이얼 등을 자유자재로 조합하여 자신만의 시계를 커스텀합니다.",
    ],
  },
  {
